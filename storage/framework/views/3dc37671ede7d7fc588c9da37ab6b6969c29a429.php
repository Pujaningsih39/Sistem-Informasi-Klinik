...
<form action="/mastermahasiswa/tambah" method="POST" enctype="multipart/form-data">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h1 class="m-0 font-weight-bold text-primary">Tambahkan Data Mahasiswa</h1>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\miniproject_2\resources\views/add_mastermahasiswa.blade.php ENDPATH**/ ?>